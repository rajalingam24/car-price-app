...
```
This Repo
|-- backend/           -> GitHub Action -> Azure Function App (mlops-predict-cicd-1645)
...
## URLs
- **Frontend:** https://wonderful-field-060db3900.7.azurestaticapps.net
- **Backend API:** https://mlops-predict-cicd-1645.azurewebsites.net/api
